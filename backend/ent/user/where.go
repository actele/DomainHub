...
// HasProviderKeys applies the HasEdge predicate on the "provider_keys" edge.
func HasProviderKeys() predicate.User {
...
// HasProviderKeysWith applies the HasEdge predicate on the "provider_keys" edge with a given conditions (other predicates).
func HasProviderKeysWith(preds ...predicate.ProviderKey) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newProviderKeysStep()
